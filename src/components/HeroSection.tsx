...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="max-w-md mx-auto mb-8 space-y-4">
            <Input
              ...
              className="bg-white/10 backdrop-blur-sm border-white/30 text-white placeholder:text-white/70 h-12"
            />
            <Input
              type="tel"
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-accent/20 rounded-full blur-xl animate-bounce-gentle" />
      <div className="absolute bottom-32 right-16 w-16 h-16 bg-secondary/20 rounded-full blur-xl animate-bounce-gentle" style={{ animationDelay: '1s' }} />
